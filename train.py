...
# ======================
# Optimizer (ĐÃ CẬP NHẬT: Sử dụng trực tiếp kết quả Tuning tối ưu nhất)
# ======================
optimizer = optim.Adam(
    model.parameters(),
    lr=1e-05,           # Kết quả tối ưu nhất của bạn (0.00001)
    weight_decay=1e-04  # Kết quả tối ưu nhất của bạn (0.0001)
)
...
print("\n🚀 Bắt đầu huấn luyện chính thức với tham số tối ưu (30 Epochs)...")
...
for epoch in range(num_epochs):
    ...
    # In log tiến trình sạch sẽ từng epoch ra màn hình
    print(
    ...
    # Save Best Model dựa trên Validation Accuracy
    if accuracy > best_accuracy:
        ...
        print(f"🔥 Đã lưu model tốt nhất! Accuracy = {accuracy:.2f}%")
